...
github_repo = "https://github.com/pavannn16/ISLRv2"
...
def animate_sign_video(sign):
    def get_hand_points(hand):
        x = [[hand.iloc[0].x, hand.iloc[1].x, hand.iloc[2].x, hand.iloc[3].x, hand.iloc[4].x],  # Thumb
             ...
             [hand.iloc[0].x, hand.iloc[5].x, hand.iloc[9].x, hand.iloc[13].x,
              hand.iloc[17].x, hand.iloc[0].x]]
        ...
        y = [[hand.iloc[0].y, hand.iloc[1].y, hand.iloc[2].y, hand.iloc[3].y, hand.iloc[4].y],  # Thumb
             ...
             [hand.iloc[0].y, hand.iloc[5].y, hand.iloc[9].y, hand.iloc[13].y,
              hand.iloc[17].y, hand.iloc[0].y]]
        return x, y
...
if __name__ == "__main__":
    ...
    for file in github_files:
        github_url = f"{github_repo}/raw/main/{file}"  # Construct URL
        local_path = Path(file)  # Local file path
        with st.spinner(f"Downloading {file}..."):
            download_file(github_url, local_path)  # Download in Streamlit interface

    # Local file paths
    dummy_parquet_skel_file = 'data/239181.parquet'
    tflite_model = 'models/asl_model.tflite'
    csv_file = 'data/train.csv'
    captured_parquet_file = 'shammers.parquet'
